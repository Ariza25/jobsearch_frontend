        ...
        <main className=" border-gray-600">
          ...
          >
            ...
            {errors?.companyName?.type === "required" && (
              <p className="text-red-600 pt-1">O nome da empresa é necessário</p>
            )}

            <label className="font-medium text-gray-600 pb-1 pt-3">CNPJ:</label>
            <input
              className={`w-full p-2.5 rounded-lg border ${
            ...
            {errors?.cnpj?.type === "required" && (
              <p className="text-red-600 pt-1">O CNPJ é necessário</p>
            )}
